...
def test_overlay_two_frames():
    ...
    path_output_name = os.path.join(os.environ.get("FRAME_PATH_OUT"), "overlayed.jpg")
...
def test_custom():
    ...
    cv2.imwrite(os.path.join(os.environ.get("PATH_IN"), "image1.png"), frame1)
    cv2.imwrite(os.path.join(os.environ.get("PATH_IN"), "image2.png"), frame2)
    path_output_name1 = os.path.join(os.environ.get("FRAME_PATH_OUT"), "overlayed1.png")
