...
if __name__ == "__main__":
    ...
    video1='samples/2022_CF_Limoges_papillon_dames_50_finaleA_fixeDroiteCompressed.mp4'
    video2='samples/2022_CF_Limoges_papillon_dames_50_finaleA_fixeGaucheCompressed.mp4'
